...
zooAnimals.Gorillas = 15;
zooAnimals.Giraffes = 8;
console.log(zooAnimals);

// Add another animal to the zoo Object, and log the updated Object.
zooAnimals.Meerkats = 21;
console.log(zooAnimals);
...
var incomingEmail = {
  ...
  from: "Laura",
  to: "Zach",
  subject: "Don't forget eggs at the store.",
  advertising: false,
  promotion: false,
  update: false,
}
...
var inbox = [
  ...
  {date: "11/17/2021",
    ...
    to: "Zach",
    subject: "$59 fares. Where to this winter?",
    advertising: true,
    promotion: true,
    update: false,
  },
  {
    ...
    to: "Zach",
    subject: "Colorado headlines for Wednesday, November 17, 2021",
    advertising: false,
    promotion: true,
    update: false,
  }

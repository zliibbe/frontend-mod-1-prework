...
var animals = ["Zebra", "Panda", "Penguin", "Snow Leopard"];
for (var i = 0; i < animals.length; i++) {
  console.log("The " + animals[i] + " is awessome!");
}

// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var foods = ["milk", "bread", "eggs", "cinnamon"];
...
var numbersToDouble = [1, 2, 3, 4, 5, 6, 7, 8];
